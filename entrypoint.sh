...
touch /var/log/ibis/pipeline.log /var/log/ibis/store.log /var/log/ibis/dlr.log /var/log/ibis/sms_report.log /var/log/ibis/backup.log /var/log/ibis/reconcile.log
